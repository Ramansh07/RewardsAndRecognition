...
public interface RewardService {
    Optional<List<RewardDTO>> createRewards(List<CreateRewardDTO> rewardDTOs) throws Exception;
    Optional<List<RewardDTO>> updateRewards(List<RewardDTO> rewardDTOs) throws Exception;
    Optional<List<RewardDTO>> deleteRewards(List<Integer> rewardIds, String userId) throws InvalidRequest, Exception;
